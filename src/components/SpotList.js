...
function SpotList({ loggedInUser }) {
  ...
  useEffect(() => {
    ...
    if (loggedInUser) {
        axios.get(`https://thisweekend.herokuapp.com/api/user/${loggedInUser}`)
            .then(res => {
  ...
  const addFavorite = (spotId) => {
    axios.put(`https://thisweekend.herokuapp.com/api/user/${loggedInUser}/addFavorite`, { spotId })
        .then(res => {
            setFavorites(res.data.favorites);
        })
        .catch(err => {
...
const removeFavorite = (spotId) => {
    axios.put(`https://thisweekend.herokuapp.com/api/user/${loggedInUser}/removeFavorite`, { spotId })
        .then(res => {
            setFavorites(res.data.favorites);
        })
        .catch(err => {
